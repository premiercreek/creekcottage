...
<div className="sidePanelgettingHereText">
			<h1>Getting Here</h1>
	<p>We are right in the centre of Queen Charlotte (see map).  There are several ways of getting here, depending on how much time you have and how adventurous you are: click the '+' button on the map to see the location of these transit points.  </p><br/>
	<p>The quickest way to get here is to <span className="green">fly to either Masset or Sandspit</span> from Vancouver.</p><br/>
	...
	<p>It is also possible to fly to Masset from Prince Rupert with <a href='http://inlandair.bc.ca/'>Inland Air Charters</a>.  Bear in mind that, since this arrives in Masset, you will need to take a taxi down to Queen Charlotte (see above).</p><br/>
	
	<p>The only scheduled sea route to Haida Gwaii is <a href='https://www.bcferries.com/seasonal-schedules?departurePort=PPR&arrivalPort=PSK'>BC Ferries'</a> service from Prince Rupert.  You can reach Prince Rupert by car (two days from Vancouver) or by train.  It's also possible to come up by ferry from Port Hardy on Vancouver Island.  <a href='http://eagletransit.net/services/transit-services/sandspit-airport-shuttle/'>Eagle Transit </a>has a taxi waiting at the ferry terminal to take you into Queen Charlotte; alternatively, hitch-hiking is easy.</p>
			</div>
</div>
	);
};
